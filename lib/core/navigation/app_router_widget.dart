...
import 'package:kingtide_challenge/core/navigation/app_router.dart';
...
class AppRouterWidget extends InheritedWidget {
  ...
  const AppRouterWidget({super.key, required this.appRouter, required super.child});
  ...
  static AppRouter of(BuildContext context) {
    final inheritedWidget = context.dependOnInheritedWidgetOfExactType<AppRouterWidget>();
